...
<script>
  ...
  export default {
    ...
    created: function () {
      ...
      this.deadline > now ? this.over=false : this.over=true;
      const date = DateTime.fromISO(this.deadline).toLocaleString(DateTime.DATETIME_FULL)
      console.log(this.deadline.toLocaleString({ locale: 'en-gb' }))
      console.log(now)
