  ...
  <div :class="style.sectionTwo">
    ...
    <div :class="style.mainContent.body">
      <div :class="style.mainContent.section.body">
        ...
        <p :class="style.mainContent.section.content"> {{programData.who_can_apply}} </p>
      </div>

      <div :class="style.mainContent.section.body">
        <p ref="whatCanYouApplyFor" :class="style.mainContent.section.text">What can you apply for?</p>
        <p :class="style.mainContent.section.content"> {{programData.whatCanYouApplyFor}} </p>
      </div>

      <div :class="style.mainContent.section.body">
        <p ref="howDoYouApply" :class="style.mainContent.section.text">How do you apply?</p>
        <p :class="style.mainContent.section.content" v-html="programData.howDoYouApply">  </p>
      </div>

      <div :class="style.mainContent.section.body">
        <p ref="howDoYouReport" :class="style.mainContent.section.text">How do you report?</p>
        <p :class="style.mainContent.section.content" v-html="programData.howDoYouReport"> </p>
      </div>

      <div :class="style.mainContent.section.body">
        <p ref="applicantSeminar" :class="style.mainContent.section.text">Applicant Seminar 2019</p>
        <p :class="style.mainContent.section.content" v-html="programData.applicantSeminar"></p>
      </div>
        ...
        <div :class="style.legalInformation.box.main">
          ...
          <div :class="style.legalInformation.box.content">
            <div :class="style.legalInformation.box.body">
              ...
              <div v-if="accordionState==1" :class="style.legalInformation.box.expandContent">{{programData.rightsOfAppeal}}</div>
              ...
              <div v-if="accordionState==2" :class="style.legalInformation.box.expandContent">{{programData.rightsOfAppeal}}</div>

              <div @click="accordion(3)" :class="[style.legalInformation.box.accordionEnd,{activeAccordion: accordionState==3}]">
                <p>Conflicts of interest</p>
                <i :class="style.legalInformation.box.icon"></i>
              </div>
              <div v-if="accordionState==3" :class="style.legalInformation.box.expandContent">{{programData.rightsOfAppeal}}</div>
            </div>
          </div>
        </div>
      </div>
