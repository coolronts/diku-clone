  ...
  export default {
    ...
    created: function (){
      ...
      for(var i=0; i<this.programData.deadline.length;i++){
        if(this.programData.deadline[i] != '/'){
          if(j==0){
            month[h] = this.programData.deadline[i]
          }
          else if(j==1){
            day[h] = this.programData.deadline[i]
          }
          else{
            year[h] = this.programData.deadline[i]
          }
          h++
        }else{
      ...
      console.log(this.programData.deadline)
    },
